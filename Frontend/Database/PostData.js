export const array = [
  {
    ...
    title:
      ' 111 This is just a title nothing else it should be ... ed when becomes to large!',
    recent_chat:
  ...
  },
  {
    id: '4',
    image:
      'https://cdn.discordapp.com/attachments/662330689521188874/698543855485714432/JPEG_20200411_201331.jpg',
    person_name: 'Siddwieufgiwuegfharth Mishra',
    title:
      'This is just  title nothing else it should be ... ed when becomes to large!',
    recent_chat:
      'This string must be passed from Database and then this would ',
    time: '14:08 15th April 2020',
    time_to_read: '5 Minute',
